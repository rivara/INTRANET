...
jQuery(document).ready(function(){
    jQuery('body').prepend('<div class="howl-iconpicker-outer"><div class="howl-iconpicker-middle"><div class="howl-iconpicker"><div class="howl-closebtn"></div><div class="howl-iconpicker-close"><i class="fa fa-times fa-2x"></i></div><input type="text" class="srchicons" placeholder="eg:google" /> <div class="iconsholder"></div></div></div></div>'); // Appending Iconpicker box below input box
